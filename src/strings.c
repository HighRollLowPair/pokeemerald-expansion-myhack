...
const u8 gText_MapleStarters[] = _("Choose one of Professor Maple's\nstarter pokémon!");
...
const u8 gText_CheckMapOfXemek[] = _("Check the map of the Xemek region.");
