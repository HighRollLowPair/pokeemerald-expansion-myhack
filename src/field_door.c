...
static const u8 sDoorAnimTiles_Fareward[] = INCBIN_U8("graphics/door_anims/fareward.4bpp");
static const u8 sDoorAnimTiles_GenericIndoor[] = INCBIN_U8("graphics/door_anims/genericindoor.4bpp");
...
static const u8 sDoorAnimPalettes_GenericIndoor[] = {12, 12, 12, 12, 12, 12, 12, 12};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Petalburg_Door_Fareward,                      DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Fareward, sDoorAnimPalettes_Oldale},
    {METATILE_GenericBuilding_Door,                         DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_GenericIndoor, sDoorAnimPalettes_GenericIndoor},
